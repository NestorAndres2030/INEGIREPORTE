...
package inegireporte.in_carterapasivos_0_1;
...
/**
 * Job: IN_CarteraPasivos Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class IN_CarteraPasivos implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "IN_CarteraPasivos.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(IN_CarteraPasivos.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (INEGICAPT_PathFile_CarteraPasivos != null) {

				this.setProperty("INEGICAPT_PathFile_CarteraPasivos", INEGICAPT_PathFile_CarteraPasivos.toString());
		...
		public String INEGICAPT_PathFile_CarteraPasivos;

		public String getINEGICAPT_PathFile_CarteraPasivos() {
			return this.INEGICAPT_PathFile_CarteraPasivos;
		}
	...
	private final String jobName = "IN_CarteraPasivos";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					IN_CarteraPasivos.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(IN_CarteraPasivos.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_INEGIREPORTE_IN_CarteraPasivos = new byte[0];
		static byte[] commonByteArray_INEGIREPORTE_IN_CarteraPasivos = new byte[0];
		...
		public void copyDataTo(row1Struct other) {
			...
			other.CONTRATOS = this.CONTRATOS;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_INEGIREPORTE_IN_CarteraPasivos.length) {
					if (length < 1024 && commonByteArray_INEGIREPORTE_IN_CarteraPasivos.length == 0) {
						commonByteArray_INEGIREPORTE_IN_CarteraPasivos = new byte[1024];
					} else {
						commonByteArray_INEGIREPORTE_IN_CarteraPasivos = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_INEGIREPORTE_IN_CarteraPasivos, 0, length);
				strReturn = new String(commonByteArray_INEGIREPORTE_IN_CarteraPasivos, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_INEGIREPORTE_IN_CarteraPasivos, 0, length);
				strReturn = new String(commonByteArray_INEGIREPORTE_IN_CarteraPasivos, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_INEGIREPORTE_IN_CarteraPasivos) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"IN_CARTERAPASIVOS\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "Guardar en DB", "tOracleOutput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("IN_CARTERAPASIVOS");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("IN_CARTERAPASIVOS");
				}
				String tableNameForSearch_tDBOutput_1 = "" + ((String) "IN_CARTERAPASIVOS") + "";
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						...
						stmtCreate_tDBOutput_1.execute("CREATE TABLE " + tableName_tDBOutput_1
								+ "(PERIODO VARCHAR2(6)   not null ,TIPO VARCHAR2(3)   not null ,IMPORTE FLOAT  not null ,CONTRATOS INT  not null ,primary key(PERIODO,TIPO))");
						if (log.isDebugEnabled())
				...
				String update_tDBOutput_1 = "UPDATE " + tableName_tDBOutput_1
						+ " SET IMPORTE = ?,CONTRATOS = ? WHERE PERIODO = ? AND TIPO = ?";
					...
					class BytesLimit65535_tFileInputExcel_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputExcel_1
									.append("FILENAME" + " = " + "context.INEGICAPT_PathFile_CarteraPasivos");
							log4jParamters_tFileInputExcel_1.append(" | ");
							log4jParamters_tFileInputExcel_1.append("PASSWORD" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:up7bmI7WNRz2WEjcvhtT3k2JNs4xt9DQBo8Sug==")
											.substring(0, 4)
									+ "...");
							log4jParamters_tFileInputExcel_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputExcel_1", "Leer Archivo", "tFileInputExcel");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}

				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:rVXKIxuS/Z5k19AoM3y0iSf9leO+t9oF9fm3wg==");
				...
				Object source_tFileInputExcel_1 = context.INEGICAPT_PathFile_CarteraPasivos;
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "row1", "tFileInputExcel_1", "Leer Archivo", "tFileInputExcel", "tDBOutput_1",
										"Guardar en DB", "tOracleOutput"
								...
								pstmt_tDBOutput_1.setFloat(1, row1.IMPORTE);

								pstmt_tDBOutput_1.setInt(2, row1.CONTRATOS);

								if (row1.PERIODO == null) {
									pstmt_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3 + count_tDBOutput_1, row1.PERIODO);
								}

								if (row1.TIPO == null) {
									pstmt_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4 + count_tDBOutput_1, row1.TIPO);
								}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputExcel_1", "Leer Archivo", "tFileInputExcel", "tDBOutput_1", "Guardar en DB",
	...
	public void tDBClose_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBClose_1", "Cerrar Conexi\u00F3n", "tOracleClose");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
	...
	public void tPrejob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tPrejob_1", "PreJOB", "tPrejob");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				cLabel = "LogVarContext";

				int tos_count_tJava_1 = 0;

				if (enableLogStash) {
					talendJobLog.addCM("tJava_1", "LogVarContext", "tJava");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}

// Indicar el inicio del proceso
				System.out.println("Proceso: IN_CarteraPasivos");
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBConnection_1", "Abrir Conexi\u00F3n", "tOracleConnection");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tJava_2", "ResetTable", "tJava");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}

// Obtener la conexión desde tDBConnection
				java.sql.Connection conn = (java.sql.Connection) globalMap.get("conn_tDBConnection_1");

// Usar las variables de contexto para el esquema y la contraseña
				String schemaName = context.dbschema;
				String schemaPassword = context.dbpassword;
				String tableName = "IN_CarteraPasivos";
...
// Imprimir el resultado
	...
	public static void main(String[] args) {
		final IN_CarteraPasivos IN_CarteraPasivosClass = new IN_CarteraPasivos();

		int exitCode = IN_CarteraPasivosClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'IN_CarteraPasivos' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'IN_CarteraPasivos' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_kmkaIGaQEe-sesTBaqPY5w");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-08-30T16:16:19.740597600Z");
		...
		try {
			...
			java.io.InputStream inContext = IN_CarteraPasivos.class.getClassLoader()
					.getResourceAsStream("inegireporte/in_carterapasivos_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = IN_CarteraPasivos.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("INEGICAPT_PathFile_CarteraPasivos", "id_String");
					if (context.getStringValue("INEGICAPT_PathFile_CarteraPasivos") == null) {
						context.INEGICAPT_PathFile_CarteraPasivos = null;
					} else {
						context.INEGICAPT_PathFile_CarteraPasivos = (String) context
								.getProperty("INEGICAPT_PathFile_CarteraPasivos");
					}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("INEGICAPT_PathFile_CarteraPasivos")) {
				context.INEGICAPT_PathFile_CarteraPasivos = (String) parentContextMap
						.get("INEGICAPT_PathFile_CarteraPasivos");
			}
		...
		log.info("TalendJob: 'IN_CarteraPasivos' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : IN_CarteraPasivos");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'IN_CarteraPasivos' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 129296 characters generated by Talend Data Management Platform on the 30 de
 * agosto de 2024, 10:16:19 CST
 ************************************************************************************************/