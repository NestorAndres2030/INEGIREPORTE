...
package inegireporte.z9_reportefinal_0_1;
...
/**
 * Job: Z9_ReporteFinal Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Z9_ReporteFinal implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Z9_ReporteFinal.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Z9_ReporteFinal.class);
	...
	private final String jobName = "Z9_ReporteFinal";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Z9_ReporteFinal.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Z9_ReporteFinal.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_INEGIREPORTE_Z9_ReporteFinal = new byte[0];
		static byte[] commonByteArray_INEGIREPORTE_Z9_ReporteFinal = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_INEGIREPORTE_Z9_ReporteFinal) {
...
///////////////////////    			
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("PASS" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:i90H6eViWkNvlgUV35cvM4+0SAZugz2xkl+1cg==")
											.substring(0, 4)
									+ "...");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"select id, name from employee\"");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("SUPPORT_NLS" + " = " + "false");
							log4jParamters_tDBInput_1.append(" | ");
				...
				url_tDBInput_1 = "jdbc:oracle:thin:@" + "" + ":" + "1521" + ":" + "";

				String dbUser_tDBInput_1 = "";

				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:2eum+OBuuo7P2/zpTzpNEbKyhM7y8odIIZp6pw==");
				...
				String dbquery_tDBInput_1 = "select id, name from employee";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "tDBInput_1", "tOracleInput", "tLogRow_1", "tLogRow_1",
								"tLogRow"
...
///////////////////////    			
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "tDBInput_1", "tOracleInput", "tLogRow_1", "tLogRow_1", "tLogRow", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// Indicar el inicio del proceso
				System.out.println("Proceso: Z9_ReporteFinal");
// Imprimir los valores de las variables de contexto
	...
	public static void main(String[] args) {
		final Z9_ReporteFinal Z9_ReporteFinalClass = new Z9_ReporteFinal();

		int exitCode = Z9_ReporteFinalClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Z9_ReporteFinal' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Z9_ReporteFinal' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_4D0kAGZDEe-F4dppsB-5aA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-08-30T07:28:27.760036100Z");
		...
		try {
			...
			java.io.InputStream inContext = Z9_ReporteFinal.class.getClassLoader()
					.getResourceAsStream("inegireporte/z9_reportefinal_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Z9_ReporteFinal.class.getClassLoader()
		...
		log.info("TalendJob: 'Z9_ReporteFinal' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Z9_ReporteFinal");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Z9_ReporteFinal' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 89981 characters generated by Talend Data Management Platform on the 30 de
 * agosto de 2024, 01:28:27 CST
 ************************************************************************************************/